...
@FmView(name="org.facematic.ui.views.Facematic")
public class Facematic implements FmBaseController {

	private static final Logger logger = LoggerFactory.getLogger(Facematic.class);

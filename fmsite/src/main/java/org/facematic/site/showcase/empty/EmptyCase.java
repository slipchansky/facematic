package org.facematic.site.showcase.empty;
...
@FmView(name="org.facematic.site.showcase.empty.EmptyCase")
public class EmptyCase implements FmBaseController {

	private static final Logger logger = LoggerFactory.getLogger(EmptyCase.class);

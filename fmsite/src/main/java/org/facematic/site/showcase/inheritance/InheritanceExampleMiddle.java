...
@FmView(name="org.facematic.site.showcase.inheritance.InheritanceExampleMiddle")
public class InheritanceExampleMiddle implements FmBaseController {

	private static final Logger logger = LoggerFactory.getLogger(InheritanceExampleMiddle.class);

...
public class FacematicDeploymentConfiguration extends DefaultDeploymentConfiguration {
	
	public FacematicDeploymentConfiguration(Class<?> systemPropertyBaseClass, Properties initParameters) {
		super(systemPropertyBaseClass, initParameters);
	}

	public FacematicDeploymentConfiguration (FacematicServlet servletInstance) {
		this (VaadinServlet.class, prepareConfiguration (servletInstance));
	}
	

	public static Properties prepareConfiguration(FacematicServlet servletInstance) {

package org.facematic.core.servlet;
...
public class FacematicDefaultUiProvider extends UIProvider {
	
	UIProvider original;
	UI ui;
	private FacematicServletService fmServletService;
	private FacematicServlet fmServletInstance;
	private Class<? extends FacematicUI> uiClass;
	private String title;
	private String theme;
	private String widgetSet;
	
	FacematicDefaultUiProvider (UIProvider original) {
	...
	public UI createInstance(UICreateEvent event) {
		...
		if (! ( service instanceof FacematicServletService) ) {
			return ui = original.createInstance(event);
		}
		
		fmServletService = (FacematicServletService)service;
	...
	public void init(FacematicSession fmSession) {
